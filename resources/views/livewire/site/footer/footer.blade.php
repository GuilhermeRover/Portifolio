<div id="contact">
    ...
    <section class="w-full pt-32 bg-white dark:bg-baseDark-dark toggle-theme">
        <div class="flex items-center justify-center">
            <a href="#" class="cursor-pointer">
                <img class="h-24" src="{{asset('images/logo3.png')}}" alt="{{__('Logo')}}">
            </a>
        </div>
        <div class="mt-10 flex items-center justify-center text-center text-gray-700 dark:text-gray-200 toggle-theme">
            <box-icon type='solid' name='envelope' class="fill-current mx-2"></box-icon>
            <div class="">
                contato.guilhermerover@gmail.com
            </div>
        </div>
        ...
        <div class="h-10 mt-14 pb-32">
            <div class="text-center font-light text-sm text-baseDark dark:text-baseLight-light toggle-theme">
